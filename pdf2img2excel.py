...
for page in range(3, len(pages)):
    ...
    parsing_option1 = False
    parsing_option2 = False
    parsing_option3 = False
    parsing_option4 = False
        ...
        for line in page_data:
            ...
            if line.startswith('Question:'):
                ...
                if parsing_question:
                    question += ' '+line
                    question = question.split("Question:")[-1]
                elif parsing_option1:
                    options1 += ' '+line
                    options1 = options1.split("Option 1:")[-1]
                elif parsing_option2:
                    options2 += ' ' + line
                    options2 = options2.split("Option 2:")[-1]
                elif parsing_option3:
                    options3 += ' ' + line
                    options3 = options3.split("Option 3:")[-1]
                elif parsing_option4:
                    options4 += ' ' + line
                    options4 = options4.split("Option 4:")[-1]
...
try:
    ...
    df.to_excel('Excel_Python_Question_Bank.xlsx')
except Exception as e:
    print(f'{str(e)}')